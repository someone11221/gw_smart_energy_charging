...
1. Nainstalujte přes HACS (viz hlavní README)
2. Restartujte Home Assistant
3. V Settings → Devices & Services → Add Integration → GW Smart Charging vyplňte požadované entity
...
- Pokud chcete vlastní SQL tabulku nebo detailní logování, můžete přidat volitelnou funkcionalitu pro zápis do recorder vlastní tabulky nebo publikaci eventů